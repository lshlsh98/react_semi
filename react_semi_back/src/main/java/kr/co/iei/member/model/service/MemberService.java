...
public class MemberService {
	...
	public LoginMember login(Member member) {
		...
		if (loginMember != null && bcrypt.matches(member.getMemberPw(), loginMember.getMemberPw())) {
			...
			login.setMemberAddr(loginMember.getMemberAddr());
	...
	@Transactional
	public int memberUpdate(String memberId, Member member) {
		...
		if (result == 1 && oldM.getMemberThumb() != null
			...
			fileUtil.deleteFile(oldM.getMemberThumb());
		}
	...
	public int memberDelete(String memberId) {
		...
		if (result == 1 && m.getMemberThumb() != null) {
			fileUtil.deleteFile(m.getMemberThumb());
		}
